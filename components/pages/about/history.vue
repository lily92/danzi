  ...
  <div class="swiper-container history flex ">
    ...
    <div class="swiper-container gallery-top ">
      <div class="swiper-wrapper">
        <div v-for="(item,i) in list" :key="'history'+i" class="swiper-slide">
          <div class="positionr">
...
$colorf:#fff;
$color6:#666;
.history::before{ display: block; content: ''; width: 100%; height: 100%; left: 0; top: 0; background: rgba(0, 0, 0, .5); position: absolute;}
.history{
  align-content: space-around; height: 100%;
  ...
  .gallery-thumbs{ max-width: 1200px; margin: 30px auto 0; height: 80px; position: relative;
  ...
  .master{ background: rgba(0, 0, 0, .5); color: #fff; padding: 20px; opacity: 0;}

}
</style>
<style lang="scss">
.gallery-top{ height: auto;}
.gallery-top .swiper-slide::after{ display: block; content: ''; width: 100px; border-bottom: 1px solid #fff; position: absolute; left: 295px ; top: 49.8%;}
.gallery-top .swiper-slide-active .master{ opacity: 1;}
</style>
